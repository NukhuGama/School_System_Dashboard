			...
			<div class="container-fluid dashboard-content ">
				...
				<div class="row">
					...
					<div class="col-xl-12 col-lg-6 col-md-6 col-sm-12 col-12">
						<div class="card">
							<h5 class="card-header">Academic Performance Majoring in Social</h5>
							<div class="card-body">
				...
				<div class="row">
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
						<div class="embed-responsive embed-responsive-16by9">
							<iframe class="embed-responsive-item" src="../../jqgrid/students/academic_social/User_View" allowfullscreen onload='javascript:(function(o){o.style.height="500px";}(this));'></iframe>
						</div>
					</div>
				</div>
			</div>
	...
	<script>
		$(document).ready(function() {
			if ($('#c3chart_stacked').length) {
				...
				$.ajax({
					type: 'POST',
					url: '/Sistem_Dashboard/json/students/json_studentacademic_social.php',
					dataType: "json",
					data: {
						table: table
					},
					success: function(data) {
						if (data.status == 'ok') {
							...
							economics1 = (data.result4.average);
							economics2 = (data.result5.average);
							economics3 = (data.result6.average);

							english1 = (data.result7.average);
							english2 = (data.result8.average);
							english3 = (data.result9.average);

							geography1 = (data.result10.average);
							geography2 = (data.result11.average);
							geography3 = (data.result12.average);
							...
							sociology1 = (data.result19.average);
							sociology2 = (data.result20.average);
							sociology3 = (data.result21.average);
