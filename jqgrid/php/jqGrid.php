...
class jqGridRender extends jqGridEdit
{
    ...
    protected $editOptions = array("drag" => true, "resize" => true, "closeOnEscape" => true, "autodataheight" => true, "errorTextFormat" => "js:function(r){ return r.responseText;}");
    protected $addOptions = array("drag" => true, "resize" => true, "closeOnEscape" => true, "autodataheight" => true, "errorTextFormat" => "js:function(r){ return r.responseText;}");
    protected $viewOptions = array("drag" => true, "resize" => true, "closeOnEscape" => true, "autodataheight" => true);
...
SUBGRID;
    ...
    public function setSelect($colname, $data, $formatter = true, $editing = true, $seraching = true, $defvals = array(), $fval = array(), $sep = ":")
    {
        $s1    = "";
        $prop  = array();
